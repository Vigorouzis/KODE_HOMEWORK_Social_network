...
//        val uved_title: TextView = itemView.findViewById(R.id.uved_title)!!
//        val uved_text: TextView = itemView.findViewById(R.id.uved_text)!!
//        val uved_imageView: ImageView = itemView.findViewById(R.id.img_uved)!!
